            ...
            <div id="frm-event_brief">
                ...
                <asp:Panel ID="PanelEvent" runat="server" BorderColor="White" BorderStyle="Dotted" BorderWidth="1" Width="800px" Height="424px">
                    <div class="fl" style="margin:6px 0px 0px 87px; position:relative;">
                        <p id="btnAddNewEvent" class="addNewEventButton" onclick="btnAddNewEventClicked()" onmouseover="btnAddNewEventOver()" onmousedown="btnAddNewEventDown()"
                            onmouseup="btnAddNewEventOver()" onmouseout="btnAddNewEventOut()"><a>Create an Event</a></p>
                    </div>
                    <div class="clearfix">
                        ...
                        <div class="clearfix fl" style="margin:6px 0px 0px 430px;width:350px;">
                            <p id="btnDeleteEvent" class="fl deleteEventButton" onclick="btnDeleteEventClicked()" onmouseover="btnDeleteEventOver()"
                                onmousedown="btnDeleteEventDown()" onmouseup="btnDeleteEventOver()" onmouseout="btnDeleteEventOut()"><a>Add a new event</a></p>
                            <p id="btnOpenEvent" style="margin-left:30px;" class="fl openEventButton" onclick="btnOpenEventClicked()" onmouseover="btnOpenEventOver()"
                                onmousedown="btnOpenEventDown()" onmouseup="btnOpenEventOver()" onmouseout="btnOpenEventOut()"><a>Add a new event</a></p>
                        </div>
                    </div>
                </asp:Panel>
                ...
                <asp:Panel ID="InvitationPanel" runat="server" BorderColor="White" BorderStyle="Dotted" BorderWidth="1" Width="800px" Height="116px">
                    ...
                    <div class="fr" style="margin:0px 290px 0px 0px; text-align: center; width:150px; padding:0px;">
                        <p id="btnAcceptInvite" class="fl acceptInviteButton" style="margin-top:10px;" onclick="btnAcceptInviteClicked();" onmouseover="btnAcceptInviteOver()"
                            onmousedown="btnAcceptInviteDown()" onmouseup="btnAcceptInviteOver()" onmouseout="btnAcceptInviteOut()"><a>Accept Invite</a></p>
                        <p id="btnRejectInvite" class="fl rejectInviteButton" style="margin-top:10px;" onclick="btnRejectInviteClicked();" onmouseover="btnRejectInviteOver()"
                            onmousedown="btnRejectInviteDown()" onmouseup="btnRejectInviteOver()" onmouseout="btnRejectInviteOut()"><a>Reject Invite</a></p>
                    </div>
                </asp:Panel>
                            ...
                            <asp:Panel ID="Panel1" runat="server" Style="margin:20px 20px 20px 20px" BackColor="Transparent">
                                ...
                                <div class="clearfix" style="margin:20px 0px 0px 0px">
                                    ...
                                    <asp:Panel ID="pnlRoundedTopic" runat="server" BackColor="White" Height="30px">
                                        <asp:TextBox CssClass="w18" ID="txtboxTopicEnter" runat="server" BorderColor="Transparent" Width="300px"></asp:TextBox>
                                    </asp:Panel>
                                </div>
                                <br />
                                <div class="clearfix" style="margin:6px 0px 0px 0px">
                                    ...
                                    <asp:Panel ID="pnlRoundedDescription" runat="server" BackColor="White" Height="110px">
                                        <asp:TextBox CssClass="w18" ID="txtboxDescriptionEnter" runat="server" BorderColor="Transparent" Rows="5" style="resize:none;"
                                ...
                                <div class="fl">
                                    <br />Starts:&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:TextBox runat="server" CssClass="w16 dateTimeTextBox calendarTextBox" Width="130" ID="inputRangeStartDate" autocomplete="off"
                                        ReadOnly="True" BackColor="Transparent" />
                                    <asp:CalendarExtender ID="calendarButtonExtenderTextBoxStart" Format="d-MMM-yyyy" runat="server" TargetControlID="inputRangeStartDate"
                                        FirstDayOfWeek="Monday" CssClass="calendarTheme" PopupPosition="TopLeft" OnClientDateSelectionChanged="onStartDateSelected"
                                    /> &nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:TextBox ID="inputRangeStartTime" runat="server" Text="10:00 AM" CssClass="w16 dateTimeTextBox timeTextBox" Width="100"
                                        BackColor="Transparent" onchange="javascript: onStartDateSelected();"></asp:TextBox>
                                </div>
                                <div class="fl">
                                    <br />Finishes:
                                    <input id="inputRangeFinishDateHidden" type="hidden" runat="server" />
                                    <asp:TextBox runat="server" CssClass="w16 dateTimeTextBox calendarTextBox" Width="130" ID="inputRangeFinishDate" autocomplete="off"
                                        ReadOnly="True" BackColor="Transparent" />
                                    <asp:CalendarExtender ID="calendarButtonExtenderTextBoxFinish" Format="d-MMM-yyyy" runat="server" TargetControlID="inputRangeFinishDate"
                                        FirstDayOfWeek="Monday" CssClass="calendarTheme" PopupPosition="TopLeft" OnClientDateSelectionChanged="onFinishDateSelected"
                                    /> &nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:TextBox ID="inputRangeFinishTime" runat="server" Text="11:00 AM" CssClass="w16 dateTimeTextBox timeTextBox" Width="100"
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="fr" style="margin:20px 20px 0px 0px;">
                                        <img id="eventTotalValueStar_1" alt=" " src="Icons/Star.png" style="margin-left:6px;" onmouseout="itemValueOut(gEventTotalValueClicked, 'eventTotalValueStar');"
                                            onmouseover="itemValueOver(1, 'eventTotalValueStar');" onclick="eventTotalValueClicked(1);"
                                        />
                                        <img id="eventTotalValueStar_2" alt=" " src="Icons/Star.png" style="margin-left:6px;" onmouseout="itemValueOut(gEventTotalValueClicked, 'eventTotalValueStar');"
                                            onmouseover="itemValueOver(2, 'eventTotalValueStar');" onclick="eventTotalValueClicked(2);"
                                        />
                                        <img id="eventTotalValueStar_3" alt=" " src="Icons/Star.png" style="margin-left:6px;" onmouseout="itemValueOut(gEventTotalValueClicked, 'eventTotalValueStar');"
                                            onmouseover="itemValueOver(3, 'eventTotalValueStar');" onclick="eventTotalValueClicked(3);"
                                        />
                                        <img id="eventTotalValueStar_4" alt=" " src="Icons/Star.png" style="margin-left:6px;" onmouseout="itemValueOut(gEventTotalValueClicked, 'eventTotalValueStar');"
                                            onmouseover="itemValueOver(4, 'eventTotalValueStar');" onclick="eventTotalValueClicked(4);"
                                        />
                                    </div>
                                </div>
                                <div class="fl" style="margin-top:20px;">
                                    <label>Add event to directory:&nbsp;</label><input type="checkbox" name="eventInDirectory"
                                        value="eventInDir" checked="checked" /><br />
                                </div>
                            </asp:Panel>
                            <div class="clearfix">
                                <br />
                ...
                <asp:ModalPopupExtender ID="ModalPopupExtender1" runat="server" TargetControlID="btnAddNewEventHidden" PopupControlID="pnlPopNewEvent"
                    CancelControlID="btnCancelEvent" DropShadow="False" BackgroundCssClass="modelBackground">
                </asp:ModalPopupExtender>
                <asp:RoundedCornersExtender ID="RoundedCornersExtender1" runat="server" TargetControlID="pnlPopInnerOuter" BorderColor="black"
                    Radius="8" Color="#000000">
                </asp:RoundedCornersExtender>
                <asp:RoundedCornersExtender ID="RoundedCornersExtender2" runat="server" TargetControlID="pnlPopInnerInner" BorderColor="black"
                    Radius="8">
                </asp:RoundedCornersExtender>

                <!-- Delete Panel Extender -->
                <span style="display: none"><asp:Button ID="btnDeleteEventHidden" runat="server" /></span>
                <asp:ModalPopupExtender ID="ModalPopupExtender2" runat="server" TargetControlID="btnDeleteEventHidden" PopupControlID="pnlPopDeleteEvent"
                    CancelControlID="btnDeleteCancel" DropShadow="False" BackgroundCssClass="modelBackground">
                </asp:ModalPopupExtender>
                <asp:RoundedCornersExtender ID="RoundedCornersExtender5" runat="server" TargetControlID="pnlPopDeleteInnerOuter" BorderColor="black"
                    Radius="8" Color="#000000">
                </asp:RoundedCornersExtender>
                <asp:RoundedCornersExtender ID="RoundedCornersExtender6" runat="server" TargetControlID="pnlPopDeleteInnerInner" BorderColor="black"
                    Radius="8">
                </asp:RoundedCornersExtender>

                <asp:RoundedCornersExtender ID="RoundedCornersExtender3" runat="server" TargetControlID="pnlRoundedTopic" BorderColor="black"
                    Radius="6">
                </asp:RoundedCornersExtender>
                <asp:RoundedCornersExtender ID="RoundedCornersExtender4" runat="server" TargetControlID="pnlRoundedDescription" BorderColor="black"
                    Radius="6">
                </asp:RoundedCornersExtender>
