    ...
    <%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
        ...
        <asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <div id="frm-login" style="position:relative;">
                ...
                of food to be shared among the group”</i><br/><br/> MyEasyPotluck is a potluck event
                        organizer.<br/> No longer you have to run around friends and <br/> family and try to organize what
                        each person<br/> will bring. No more headache, no more stress.<br/><br/>
                    ...
                    <div class="login-box">
                        <div style="padding:0px 0px 0px 350px; ">
                            <p id="btnNeedReminder" class="needReminder" style="margin:0px;" onclick="needReminderClicked()" onmouseover="needReminderMouseOver()"
                                onmousedown="needReminderMouseDown()" onmouseup="needReminderMouseOver()" onmouseout="needReminderMouseOut()"><a>Need a Reminder</a></p>
                        </div>
                        <div class=" wb12" style="padding-top:4px;">
                            ...
                            <div class="txt-bg fl" style="margin-left:6px">
                                <input class="w16" id="txtPassword" style="border:0; width:150px; height:21px;" type="password" name="Password" tabindex="2"
                                    onkeydown="if (event.keyCode == 13) btnGoClicked();" />
                            </div>
                            <div class="fl" style="margin:1px 14px 0px 2px">
                                <p id="btnGo" class="goButton" style="margin:0px;" onclick="btnGoClicked()" onmouseover="btnGoMouseOver()" onmousedown="btnGoMouseDown()"
                                    onmouseup="btnGoMouseOver()" onmouseout="btnGoMouseOut()"><a tabindex="3">Go</a></p>
                            </div>
                        </div>
                        ...
                        <asp:Panel ID="pnlPopEmailReminderInnerInner" runat="server" CssClass="emailReminderInnerInnerPopup" BackColor="#FDF8E3">
                            <div style="margin:10px 20px 0px 20px;">
                                ...
                                <p class="clearfix" style="text-align: center;">
                                    <input id="btnOkEmailReminderPopup" value="Send" onclick="OkEmailReminderPopupClick();" class="myButton" style="margin: 10px 0px 10px 0px;"
                                        type="button" />
            ...
            <asp:Button ID="btnCloseEmailReminderPopup" runat="server" />
                ...
                <asp:ModalPopupExtender ID="ModalPopupExtender4" runat="server" TargetControlID="btnOpenEmailReminderPopup" PopupControlID="pnlPopEmailReminder"
                    OkControlID="btnCloseEmailReminderPopup" CancelControlID="btnCancelEmailReminderPopup" DropShadow="False"
                    BackgroundCssClass="modelBackground">
                </asp:ModalPopupExtender>
                <asp:RoundedCornersExtender ID="RoundedCornersExtender7" runat="server" TargetControlID="pnlPopEmailReminderInnerOuter" BorderColor="black"
                    Radius="8" Color="#000000">
                </asp:RoundedCornersExtender>
                <asp:RoundedCornersExtender ID="RoundedCornersExtender8" runat="server" TargetControlID="pnlPopEmailReminderInnerInner" BorderColor="black"
                    Radius="8">
                </asp:RoundedCornersExtender>
