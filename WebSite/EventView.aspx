<%@ Page Title="" Language="C#" MasterPageFile="~/Home/global.master" AutoEventWireup="true" CodeFile="EventView.aspx.cs" Inherits="EventView" %>
        ...
        <div class="clearfix fl">
            <asp:Panel ID="PanelEventDetail" runat="server" CssClass="detailedPanel fl" Width="372px" Height="390px" style="margin-left:70px" >
                <div class="clearfix" style="margin:0px 0px 0px 20px;">
                    ...
                    <br />
                    <asp:TextBox CssClass="clearfix fl w18 boxBorder"  ID="txtboxTopicEnter" runat="server" Width="330px" ReadOnly="True" BorderStyle="None" BackColor="Transparent" Enabled="True"></asp:TextBox>
                ...
                <div style="margin:110px 0px 0px 20px;" class="clearfix">
                    <div style="margin:20px 0px 0px 0px;">
                        ...
                        <div class="fr" style="margin:0px 20px 0px 0px;">
                            <asp:TextBox runat="server"  CssClass="w16 dateTimeTextBox boxBorder" Width="130" ID="inputRangeStartDate" autocomplete="off" ReadOnly="True" BorderStyle="None" BackColor="Transparent"  />
                            <asp:TextBox ID="inputRangeStartTime"  runat="server" Text="" CssClass="w16 dateTimeTextBox boxBorder" Width="100"   ReadOnly="True" BorderStyle="None" BackColor="Transparent"   ></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div style="margin:4px 0px 0px 0px;" class="clearfix">
                        ...
                        <div class="fr" style="margin:0px 20px 0px 0px;">
                            <asp:TextBox runat="server"  CssClass="w16 dateTimeTextBox  boxBorder" Width="130" ID="inputRangeFinishDate" autocomplete="off" ReadOnly="True" BorderStyle="None" BackColor="Transparent"    />
                            <asp:TextBox ID="inputRangeFinishTime"  runat="server" Text="" CssClass="w16 dateTimeTextBox  boxBorder" Width="100" ReadOnly="True" BorderStyle="None" BackColor="Transparent"   ></asp:TextBox>
                        </div>
                    </div>
            ...
            <asp:Panel ID="PanelFriendsInvite" runat="server" CssClass="clearfix detailedPanel fl"  Width="372px" Height="141px" style="margin: 400px 0 0 70px" >
                ...
                <div class="fl" style="margin:-12px 0px 0px 20px; text-align: center; width:370px" >
                    <p id="btnFriendProfile" class="fl friendProfileButton" onclick="btnFriendProfileClicked()" onmouseover="btnFriendProfileOver()" onmousedown="btnFriendProfileDown()" onmouseup="btnFriendProfileOver()" onmouseout="btnFriendProfileOut()" ><a  >Friend Profile</a></p>
                </div>	            
            </asp:Panel>      
            ...
            <asp:Panel ID="PanelEventItems" runat="server" CssClass="detailedPanel fl" Width="416px" Height="540px" style="margin: 0px 0 0 460px">
	            ...
	            <div style="margin-top:10px;">
	                ...
	                <div class="fl" style="margin:-10px 0px 0px 14px;">
	                    <div>
	                        <div class="clearfix">
	                            <p id="btnHoldHolding" style="margin:34px 3px 0px 0px;" class="fr holdItemButton" onclick="HoldHoldingClick()" onmouseover="btnHoldItemOver()" onmousedown="btnHoldItemDown()" onmouseup="btnHoldItemOver()" onmouseout="btnHoldItemOut()" ><a  >I'll Bring It</a></p>
	                        </div>
	                    </div>
	                </div>
	            <div>
