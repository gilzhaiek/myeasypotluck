<%@ Page Title="" Language="C#" MasterPageFile="~/Home/global.master" AutoEventWireup="true" CodeFile="Signup.aspx.cs" Inherits="Signup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="fl signup-container">
        <div class="clearfix signup-spacer">
            <div class="txt-bg fl">
                <input class="fl w16 inputBox" id="txtEmail" autocomplete="off" style="border:0; width:190px; height:21px; margin-left:18px;" type="text" name="Email" tabindex="1" />
    ...
    <div class="clearfix" id="dvbtnsignup">
        ...
        <div class="signup-spacer" style="padding-right:240px; padding-top:1px;" >
            <p id="btnCreateMe" class="createMeButton" onclick="btnCreateMeClicked()" onmouseover="btnCreateMeOver()" onmousedown="btnCreateMeDown()" onmouseup="btnCreateMeOver()" onmouseout="btnCreateMeOut()" ><a tabindex="7">Create Me</a></p>
        </div>
    </div>
    </div>
